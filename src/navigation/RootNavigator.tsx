      ...
      screenOptions={{
        ...
        headerRight: () => (
          <View style={{ flexDirection: 'row', marginRight: 8, alignItems: 'center' }}>
            ...
            >
              <Text style={{ color: colors.tint, fontFamily: typography.fontFamily.sans, fontWeight: '600' }}>Settings</Text>
            </TouchableOpacity>
          </View>
        ),
      }}
        ...
        return (
          <Tab.Screen
            ...
            options={{
              ...
              tabBarIcon: ({ color }) => (
                <config.Icon color={color} size={25} />
              ),
            }}
          />
        );
  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['right', 'left']}>
      ...
      <Stack.Navigator initialRouteName={initialRouteName}>
        ...
        <Stack.Screen name="Main" component={TabNavigatorScreen} options={{ headerShown: false }} />
        <Stack.Screen 
          name="Article" 
