...
export const MOCK_ARTICLES: Article[] = [
  // TOP
  {
    ...
    summary:
      "The proposed timeline for the new span across the Monongahela has drawn both praise and criticism from local leaders.",
    body: BODY_TEXT,
    source: "City Desk",
    ...
    category: "Top",
    readTimeMinutes: 5,
    tags: ["infrastructure", "council", "politics"],
  ...
  },
  {
    ...
    summary:
      "Authorities have reopened all lanes following a multi-vehicle collision early this morning.",
    body: BODY_TEXT,
    ...
    contentWarnings: ["disaster", "violence-realistic"],
  ...
  },
  {
    ...
    summary:
      "As the season approaches, the defense is looking sharper than ever, but questions remain about the offensive line.",
    body: BODY_TEXT,
    source: "Sports Desk",
  ...
  // LOCAL
  {
    ...
    summary:
      "The popular weekend market will now extend to two additional blocks starting next month.",
    body: BODY_TEXT,
  ...
  // CULTURE
  {
    ...
    summary:
      "A look back at the steel workers who built the city, featuring never-before-seen photographs.",
    body: BODY_TEXT,
    source: "Arts & Life",
  ...
  },
  {
    ...
    summary:
      "We ranked the top 5 places to get your morning brew, from classic Italian espresso to modern pour-overs.",
    body: BODY_TEXT,
    source: "Food & Drink",
