        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <Text style={styles.description}>
                    Customize how you read and interact with articles.
                </Text>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.toggleRow}>
                        <View style={styles.toggleTextContainer}>
                            ...
                            <Text style={styles.toggleDesc}>
                                Breathing exercises for sensitive content.
                            </Text>
                        </View>
                        <Switch 
                    ...
                    <View style={styles.speedRow}>
                        {[200, 250, 300, 350, 400, 450, 500].map(speed => (
                            <TouchableOpacity 
                                ...
                                style={[
                                    styles.speedOption, 
                                    readingSpeed === speed && styles.selectedSpeed
                                ]}
                                onPress={() => setReadingSpeed(speed)}
                            >
                                <Text style={[
                                    styles.speedText,
                                    readingSpeed === speed && styles.selectedSpeedText
                                ]}>{speed}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                    ...
                    <View style={styles.fontRow}>
                        {[
                            ...
                            <TouchableOpacity 
                                ...
                                style={[
                                    styles.fontOption, 
                                    fontSize === option.value && styles.selectedFont
                                ]}
                                onPress={() => setFontSize(option.value)}
                            >
                                <Text style={[
                                    styles.fontText,
                                    fontSize === option.value && styles.selectedFontText
                                ]}>{option.label}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
