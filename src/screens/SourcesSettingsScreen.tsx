            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.section}>
                    ...
                    >
                        ...
                        <Text style={styles.addButtonText}>Add Custom RSS Feed</Text>
                    </TouchableOpacity>

                    {showAddCustom && (
                        <View style={styles.customForm}>
                            <Text style={styles.formLabel}>Feed Name</Text>
                            <TextInput
                                style={styles.input}
                                placeholder="e.g., My Local Blog"
                                value={customName}
                                onChangeText={setCustomName}
                                placeholderTextColor={colors.textSecondary}
                            />

                            <Text style={styles.formLabel}>RSS Feed URL</Text>
                            <TextInput
                                style={styles.input}
